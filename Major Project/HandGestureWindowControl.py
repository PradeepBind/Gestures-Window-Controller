...
def run_eye_controller_script():
    try:
        subprocess.run(["python", "e.py"], check=True)
    except subprocess.CalledProcessError as e:
        print(f"Error running eye controller script: {e}")
...
while True:
    ...
    if hands:
        ...
        # Check if middle and ring fingers are up
            if finger1[2] == 1 and finger1[3] == 1:
                
                # Execute the eye controller script
                print("doneee")
                run_eye_controller_script()
